...
import ru.ogpscenter.maps3d.utils.area.CoordinateAttributed;
...
public class RandomForestEvaluator {
    ...
    public CachedTracer<AttributedIsoline> intersector;
...
//        if (reduced && (con.features[score] < draftScoreThreshold))  return;
        ...
        for (LineSegmentWrapper lsw_d : ret_buf) {
            LSWAttributed<AttributedIsoline> lsw = (LSWAttributed<AttributedIsoline>)lsw_d;
...
//        8: inters_score_mean
     ...
     * @return
     */
    public ArrayList< Connection_attributed > getConnections(ArrayList<AttributedIsoline> isos_attributed, GeometryFactory gf, boolean reduced) {
        /*Asess by features:
        ...
        for (AttributedIsoline iso : isos_attributed) {
    ...
    public RandomForestEvaluator(CachedTracer<AttributedIsoline> intersector) {
...
//    public ArrayList<Pair<Connection,double[]>> getFeatures(ArrayList<AttributedIsoline> isos_attributed, GeometryFactory gf) {
//                /*Asess by features:
//           'angle1', 'angle2', 'distance', 'score', 'cons_score_max', 'cons_score_mean',
//           'cons_curMax', 'inters_score_max',
//           'inters_score_mean'
...
//
//        ArrayList<Connection_attributed> pre_ret = new ArrayList<>();
//        /*Run through all pairs of ru.ogpscenter.maps3d.isolines*/
//
...
//            CommandLineUtils.reportProgress(i,isos_attributed.size());
//            AttributedIsoline i1 = isos_attributed.get(i);
//
...
//                AttributedIsoline i2 = isos_attributed.get(j);
//
