package ru.ogpscenter.maps3d.algorithm.dataset;
...
import ru.ogpscenter.maps3d.algorithm.repair.RandomForestEvaluator;
...
public class Datagen {
    ...
    public static void genData(String outPath) {
        ...
        System.out.println( "Loaded " + cont.size() + "ru/ogpscenter/maps3d/isolines");
